...
void VulkanRenderer::draw(GlfwAppWindow &window) {
...
void VulkanRenderer::initVulkan(GlfwAppWindow &window) {
	this->createInstance();
...
void VulkanRenderer::recreateSwapChain(GlfwAppWindow &window) {
...
void VulkanRenderer::createSwapChain(GlfwAppWindow &window) {
	...
	vkGetSwapchainImagesKHR(this->device, swapChain, &imageCount, this->swapChainImages.data());
...
void VulkanRenderer::createGraphicsPipeline() {
	auto vertShaderCode = VulkanRenderer::readFile("bin/shader/simple_shader.vert.spv");
	auto fragShaderCode = VulkanRenderer::readFile("bin/shader/simple_shader.frag.spv");
...
void VulkanRenderer::drawFrame(GlfwAppWindow &window) {
	...
	vkResetCommandBuffer(this->commandBuffers[currentFrame], /*VkCommandBufferResetFlagBits*/ 0);
...
VkExtent2D VulkanRenderer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities, GlfwAppWindow &window) {
